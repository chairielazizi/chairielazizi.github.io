        ...
        <div className='flex flex-col gap-y-8 lg:flex-row items-center'>
          ...
          <div className='flex-1 text-center font-secondary lg:text-left'>
            ...
            <motion.p variants={fadeIn('up', 0.6)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.7}} className='mb-8 max-w-lg mx-auto lg:mx-0'>
              Just living life like everybody else do. Love networking, play with raspberry pi and docker, and of course test any applications or website as that what I usually do. Sometimes code. 
            </motion.p>
            <motion.div variants={fadeIn('up', 0.7)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.7}} className='flex gap-x-6 items-center mb-12 max-w-max mx-auto lg:mx-0'>
              <button className='btn btn-lg'>Hit Me Up</button>
              <a href='#' className='text-gradient1 btn-link'>
                My Portfolio
              </a>
            </motion.div>
            <motion.div variants={fadeIn('up', 0.7)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.7}} className='flex text-[27px] gap-x-6 max-w-max mx-auto lg:mx-0'>
              {/* social */}
              <a href=''><FaGithub/></a>
              <a href=''><FaYoutube/></a>
            </motion.div>
          ...
          {/* image */}
          <motion.div variants={fadeIn('down', 0.5)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.7}} className='hidden lg:flex flex-1 max-w-[320px] lg:max-w-[480px]'>
